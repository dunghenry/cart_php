    ...
    if ($pname != "" && $category_id > 0 && $amount > 0 && $price > 0 && !empty($file_name)) {
        ...
        if (in_array($file_extension, $extensions)) {
            if ($file_size <= 1000000) {
                $sql = "update `products` set productname='$pname',category_id='$category_id',amount='$amount', price='$price',image='$generated_file_name' WHERE id=$id";
        ...
        <div class="mx-auto" style="width: 500px;">
            <form method="POST" enctype="multipart/form-data">
                <div class="col-md-3" style="width: 100%;">
                    ...
                    <input type="text" class="form-control" name="pname" id="pname" value=<?php echo $pnamevl ?>>
                </div>
                ...
                <div class="col-md-3 col mt-2" style="width: 100%;">
                    ...
                    <input type="number" class="form-control" name="amount" id="amount" value=<?php echo $amountvl ?>>
                </div>
                <div class="col-md-3 col mt-2" style="width: 100%;">
                    <label for="price" class="form-label">Price</label>
                    <input type="number" class="form-control" name="price" id="price" value=<?php echo $pricevl ?>>
                </div>
                <div class="col-md-3 col mt-2" style="width: 100%;">
